...
<div class="container my-4">
    ...
    <div class="row center flex-space-between mx-1">
        ...
        <div class="col-md-4 box_shadow p-3 my-1">
            <button class="btn btn-primary w-100 text-capitalize" id="create_btn">Create Distributor Author Type</a>
        </div>
        
    </div>
    <form action="{{ route('admin.distAuthTypes.store')}}" method="post" id="create" class="d-none">
        @csrf
        <div class="row box_shadow m-2 p-2 my-3">
            <div class="col-12 border-bottom">
                <h4>Create Distributor Author Type</h4>
            </div>
            <div class="col-md-4">
...
<div class="container mt-3">
    ...
    <table class="table table-secondary">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$type->name}}</td>
                <td>
                    <a href="{{ route('admin.distAuthTypes.edit', $type->id)}}">
                        <button class="btn btn-primary">Edit</button>
                    </a>
                </td>
                <td>
                    <form action="{{ route('admin.distAuthTypes.destroy', $type->id)}}" method="post">
                        @csrf
                        @method('DELETE')
    ...
    @else
    <h3 class="text-center">No Dist Author Types</h3>
    @endif
</div>
@endsection
