...
<div class="container my-4">
    ...
    <form action="{{ route('admin.answersComplains.store', $complaint->id)}}" method="post">
        @csrf
        <div class="row box_shadow m-2 p-2 my-3">
            <div class="col-12 border-bottom">
                <h4>Send Answer to {{$complaint->dist->name}}</h4>
            </div>
            <div class="col-md-12">
            ...
            {{-- <div class="col-md-6">
                ...
                <textarea name="answer" id="" rows="10" class="p-2" style="width: 100%"></textarea>
            </div> --}}
