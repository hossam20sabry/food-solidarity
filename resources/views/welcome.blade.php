    ...
    <div class="mainBackground">
        <div class="container">
            <div class="content">
                ...
                <a href="./pages/selectAuth.html" class="btn btn-success m-2">Get Started</a>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-sm-6 mb-5">
                <div class="row">
                    <div class="col">
                        <img src="{{asset('/home/img/Tiny people standing near box of donation food for delivery.jpg')}}" alt="" class="img-fluid">
                    </div>
                </div>
