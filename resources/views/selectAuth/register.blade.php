    ...
    <div class="row d-flex justify-content-center align-items-center gap-3">
        <div class="card m-2 card-responsive card-width">
            ...
            <div class="card-body">
                ...
                <a href="{{route('dist.register')}}" class="btn w-100 background4">Sign Up as Distributor</a>
            </div>
        </div>
        <div class="card m-2 card-responsive card-width">
            ...
            <div class="card-body">
                ...
                <a href="{{route('register')}}" class="btn w-100 background3">Sign Up as Beneficiary</a>
            </div>
        </div>
    </div>
